...
def process_video(
    ...
    while True:
        ...
        cv2.putText(display_frame, status, (10, height - 20),
        ...
        if frame_idx % 30 == 0:
            ...
            print(f"Progress: {progress:.1f}% | Frame: {frame_idx}/{total_frames} | HR: {current_hr:.1f} BPM | Conf: {current_conf:.2f}")
...
def main():
    ...
    parser.add_argument('--method', '-m', choices=['chrom', 'pos', 'auto'], 
                       default='chrom', help='Signal extraction method')
